...
wire tlb_commit   = es_valid && !wb_ex && !ertn_flush;
...
wire        s1_found;
wire [ 3:0] s1_index;
wire [18:0] s1_vppn = inst_tlbsrch ? csr_tlbehi[31:13] : rkd_value[31:13];
wire        s1_va_bit12 = inst_tlbsrch ? csr_tlbehi[12] : rkd_value[12];
wire [ 9:0] s1_asid = inst_tlbsrch ? csr_asid : rj_value[9:0];
