...
assign src_reg_is_rd = branch_op | store_op;
...
assign gr_we         = ~store_op & ~branch_op & ~inst_b;
...
assign src_no_rk = inst_slli_w | inst_srli_w | inst_srai_w | inst_addi_w | load_op | store_op
                   | inst_jirl | inst_b | inst_bl | branch_op | inst_lu12i_w | inst_pcaddu12i | inst_slti | inst_sltui | inst_andi | inst_ori | inst_xori;
assign src_no_rd = ~store_op & ~branch_op;
